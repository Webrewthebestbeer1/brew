    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brew', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='log.Brew')),
            ],
        ),
        migrations.CreateModel(
            name='Equipment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brew', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='logs', to='log.Brew')),
            ],
        ),
        migrations.CreateModel(
            name='Malt',
        ...
        migrations.AddField(
            model_name='malt',
            name='recipe',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='malts', to='log.Recipe'),
        ),
        migrations.AddField(
            model_name='hop',
            name='recipe',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hops', to='log.Recipe'),
        ),
        migrations.AddField(
            model_name='brew',
            name='recipe',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='brews', to='log.Recipe'),
        ),
    ]
